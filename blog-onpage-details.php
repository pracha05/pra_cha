...
<title>Prachatech | Blog</title>
    ...
    box-shadow: 0 3px 2px rgba(0, 0, 0, 0.04);
		 ...
		 <section class="inner-banner py-4">
            <div class="container">
                <div class="contents">
                    <h1>Onpage And Offpage SEO</h1>
                    <p>As up to today there were 300,000,000+ registered websites on the internet! <span>Most of us rely on search engines to find what we want on the internet.</span></p>
                </div>
            </div>
        </section>
        ...
        <section class="blog-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-lg-8">
                        <div class="blog-content blog-detailed">
                              <figure class="blog-pic"><img class="img-fluid img-thumbnail" src="images/blog/onpage-and-offpage-optimization.png" alt="optimization"></figure>
                            <p class="time">15-March  <span>2018 </span></p>
                            <h5>What is Onpage and Offpage Optimization?</h5>
                         
                            <p>Generally in this digitalized world, people search on the web for products, services, information etc., with related keywords in the search bar of Google, Bing, Yahoo, Ask, AOL, and other search engines; and they will be satisfied when they come across what they seek. The process of displaying that selected page or website in the search engine results page is carried out by optimizing of a website or a page, and this process is known as Search Engine Optimization.</p> 
							<p>SEO is the acronym for “Search Engine Optimization”. In simple SEO is the process of getting traffic from the "Organic" or "Natural" search results on search engines results page (SERP).</p>
			 ...
			 <div class="row">
                ...
                <div class="row">
                    <div class="col-md-10 mb-20 pt-30 ">
                        <h5>SEO is of two types :</h5>
                        <ol class="pad-lr15">
                            <li class="py-2">
                                <span class="text-warning">On-Page Optimization</span>
                            </li>
                            <li>
                                <span class="text-warning">Off-Page Optimization</span>
                            </li>
                        </ol>
                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-12 mb-20 pt-30  ">
                        ...
                        <div class="row py-2">
                            ...
                            <div class="col-10">
                                <h5 class=" text-left  dark-grey-text font-w-400">Never do these two : </h5>
                        ...
                        <div class="row py-2">
                            ...
                            <div class="col-10">
                                <h5>Blog Directory Submission : </h5>
