<?php include("header.php"); ?>
 ...
 <title>Prachatech Services</title>
  <meta name="keywords" content="BEST SOFTWARE SOLUTIONS IN HYDERABAD">
                ...
                <div class="banner slide2">
                    <div class="container mt-100">
                        <div class="row cnt-block">
                            <div class="col-md-7">
                                <div class="left">
                                    <h1 id="" class="animated fadeInLeft delay-02s">SOFTWARE DEVELOPMENT COMPANY IN HYDERABAD</h1>
                                    <p class="animated fadeInLeft delay-03s"> Complex Problems...! | Simple Solutions..!</p>
                                </div>
                            </div>
                ...
                <div class="banner slide3">
                    <div class="container mt-100">
                        <div class="row cnt-block">
                            <div class="col-md-12">
                                <div class="left">
                                    <h1 class="animated fadeInDown delay-02s">WEB DEVELOPMENT COMPANY IN HYDERABAD </h1>
                                    <p class="animated fadeInDown delay-03s"> Complex Problems...! | Simple Solutions..!</p>
                                     </div>
                            </div>
                        </div>
                        <div class="row">
		...
		<section class="how-it-work-items py-4">
            <div class="container">
			...
			<div class="call-action-bar bg ">
                <div class="container">
                    <h4><span>Start the supporting system that you always.</span><a class="btn blue" href="contact.php">Contact Us</a></h4>
                </div>
            </div>
		<section class="client-speak carousel4 grey-bg">
            <div class="container">
               <header class="page-header section-header text-center wow slideInRight py-5" data-wow-delay=".1s">
						<h1 class="h-bold " >Industries <span class="">We </span> Serve</h1>
						<span class="line text-center"></span> 
				</header>
                <ul class="speak-listing opt4 owl-carousel">
                    <li>
                        <div class="inner"> 
...
<script>
  /**************************
        ...
        if ($element.length > 0) {
            new Typed('#typed', {
                strings: ['WEB DESIGNING', 'WEB DEVELOPMENT', 'APP DEVELOPMENT', 'DIGITAL MARKETING'],
                typeSpeed: 55,
                backSpeed: 55,
                smartBackspace: true,
                loop: true
