            ...
            <div class="container">
                ...
                <div class="tab-content">
					...
					<h2 class="text-center">Search Engine Optimization</h2>
						...
						<img style="width:250px;height:auto;" src="images/seo.png" class=" thumbnail">
						</div>
                        <p>
					...
					<div role="tabpanel" class="tab-pane " id="tab2">
						...
						<div class="py-4 text-center">
						<img style="height:220px;width:auto;" src="images/social-media-marketing.png" class=" thumbnail">
						</div>
					...
					<div role="tabpanel" class="tab-pane " id="tab3">
                       <h2 class="text-center">Google Adwords</h2>
						<div class="py-4 text-center">
						<img style="height:200px;width:auto;" src="images/google-adwords.png" class=" thumbnail">
						</div>
					...
					<div role="tabpanel" class="tab-pane " id="tab4">
                       <h2 class="text-center">Content Marketing</h2>
						<div class="py-4 text-center">
						<img style="width:300px;height:auto;" src="images/content-marketing.png" class=" thumbnail">
						</div>
					...
					<div role="tabpanel" class="tab-pane " id="tab5">
						...
						<div class="py-4 text-center">
						<img style="width:300px;height:auto;" src="images/email-marketing.png" class=" thumbnail">
						</div>
					...
					<div role="tabpanel" class="tab-pane " id="tab6">
                      <h2 class="text-center">Google Analytics</h2>
						<div class="py-4 text-center">
						<img style="width:300px;height:auto;" src="images/google-analytics.png" class=" thumbnail">
						</div>
