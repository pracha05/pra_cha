...
//echo "<pre>";print_r($_POST);exit;
		...
		move_uploaded_file($_FILES['myfile']["tmp_name"],"assets/marketing_manager/" . $_FILES['myfile']["name"]);

		$sql="INSERT INTO marketing_manager(f_name,l_name,email,phone,location,link_profile,website,message,myfile)
