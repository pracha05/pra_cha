...
//echo "<pre>";print_r($_POST);exit;
		...
		move_uploaded_file($_FILES['myfile']["tmp_name"],"assets/developer/" . $_FILES['myfile']["name"]);

		$sql="INSERT INTO developer(f_name,l_name,email,phone,location,link_profile,website,message,myfile)
