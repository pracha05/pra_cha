...
//echo "<pre>";print_r($_POST);exit;
		...
		move_uploaded_file($_FILES['myfile']["tmp_name"],"assets/android_developer/" . $_FILES['myfile']["name"]);

		$sql="INSERT INTO android_developer(f_name,l_name,email,phone,location,link_profile,website,message,myfile)
VALUES('".$_POST['f_name']."','".$_POST['l_name']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['location']."','".$_POST['link_profile']."','".$_POST['website']."','".$_POST['message']."','".$_FILES['myfile']["name"]."')";
        ...
        //echo'<pre>';print_r($message);exit;
			...
			header("Location:apply-job-android-developer.php?success=1");
			} else{
			echo 'Unable to send email. Please try again.';
			header("Location:apply-job-android-developer.php?success=2");
			}
		}
			$conn->close();
			}
