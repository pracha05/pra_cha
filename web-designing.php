...
<section class="faq-outer grey-bg padding-lg" id="faq-sec">
	<div class="container">
		...
		<div class="row py-4">
			<div class="col-md-6">
				<p>In general there are two types of keywords, namely: Short tail keywords and Long tail keywords. For instance:
					<br>"Web Designing" - Is a short tail keyword.</br>"Web Designing Agency in Hyderabad" - Is a long tail keyword.</p>
				<p class="">There is another technique called LSI Keyword technique which means “Latent Semantic Indexing” keywords. These keywords are semantically related to your primary keywords. For Instance: If you are searching for "web designing agency" located in Hyderabad, you will find the below listed LSI keywords.</p>
				<div class="lsi-help">
