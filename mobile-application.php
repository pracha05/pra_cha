            ...
            <div class="container">
                ...
                <div class="tab-content">
					...
					<h2 class="text-center">IOS Mobile App Development</h2>
						...
						<img style="width:300px;height:auto;" src="images/ios-app-development.png" class=" thumbnail">
						</div>
					...
					<div role="tabpanel" class="tab-pane " id="tab2">
						...
						<div class="py-4 text-center">
						<img style="width:300px;height:auto;" src="images/android-app-development.png" class=" thumbnail">
						</div>
					...
					<div role="tabpanel" class="tab-pane " id="tab3">
                       <h2 class="text-center">Hybrid Mobile App Development</h2>
						<div class="py-4 text-center">
						<img style="width:300px;height:auto;" src="images/hybrid-app-development.png" class=" thumbnail">
						</div>
					...
					<div role="tabpanel" class="tab-pane " id="tab4">
                       <h2 class="text-center">Mobile Integration</h2>
						<div class="py-4 text-center">
						<img style="width:300px;height:auto;" src="images/mobile-intigaration.png" class=" thumbnail">
						</div>
					...
					<div role="tabpanel" class="tab-pane " id="tab5">
						...
						<div class="py-4 text-center">
						<img style="width:300px;height:auto;" src="images/mobile-app-testing.png" class=" thumbnail">
						</div>
					...
					<div role="tabpanel" class="tab-pane " id="tab6">
                      <h2 class="text-center">Mobile Application Security</h2>
						<div class="py-4 text-center">
						<img style="width:300px;height:auto;" src="images/mobile-app-security.png" class=" thumbnail">
						</div>
